...
#include <onebot/transport/http/OneBotHttpEventController.hpp>

auto insoulforge::OneBotHttpEventController::receiveOneBotEvent(const drogon::HttpRequestPtr req,
